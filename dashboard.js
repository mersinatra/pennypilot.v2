...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('open-category-modal-page')?.addEventListener('click', openCategoryModal);
    ...
    try {
        ...
        data.forEach(c => {
            ...
            row.innerHTML = `<span>${c.name}</span>
                <div>
                    <button class="text-xs text-blue-400 mr-2" onclick="editCategory(${c.id})">Edit</button>
